...
- **⚠ 2026-06-18 に個人向け無料枠（1日1,000リクエスト）は終了**（個人 OAuth は Antigravity CLI へ移行。現在は GEMINI_API_KEY による API 従量課金）
- 委譲のたびに課金が発生するため、質問は統合し、軽いリサーチは Claude subagent（WebSearch/WebFetch）での代替を先に検討する
